...
class ScenarioRunner(object):
    ...
    def _analyze_scenario(self, config):
        ...
        if not self.manager.analyze_scenario(self._args.output, filename, junit_filename, self.curr_scenario):
...
def main():
    ...
    parser.add_argument('--output', action="store_true", help='Provide results on stdout', default=True)
